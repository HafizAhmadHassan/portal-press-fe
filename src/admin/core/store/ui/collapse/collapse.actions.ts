...
export const setCollapseError = createAction<string | null>('collapse/setError');

// Actions per gestione bulk
export const bulkRegisterCollapses = createAction<Array<{
  id: string;
  autoClose?: boolean;
}>>('collapse/bulkRegister');

export const bulkToggleCollapses = createAction<string[]>('collapse/bulkToggle');