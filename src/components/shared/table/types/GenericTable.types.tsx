...
export interface GenericTableWithLogicProps<T = any> extends Omit<GenericTableProps<T>, 'paginatedData' | 'currentPage' | 'totalPages' | 'selectedItems' | 'sortConfig' | 'onSort' | 'onPageChange' | 'onSelectAll' | 'onSelectItem'> {
