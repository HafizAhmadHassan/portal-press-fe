    ...
    <div className={styles.summarySection}>
      ...
      <div className={styles.summaryContent}>
        <div className={styles.summaryItem}>
          <strong>Nome Macchina:</strong> {formData.machineName || 'Non specificato'}
        </div>
        <div className={styles.summaryItem}>
          <strong>Stato:</strong> {formData.status === 1 ? 'Attivo' : 'Inattivo'}
        </div>
        <div className={styles.summaryItem}>
        ...
        <div className={styles.summaryItem}>
          ...
          {formData.address || `${formData.street} ${formData.city}`.trim() || 'Non specificata'}
        </div>
        <div className={styles.summaryItem}>
        ...
        <div className={styles.summaryItem}>
          <strong>IP Router:</strong> {formData.ipRouter || 'Non specificato'}
        </div>
        <div className={styles.summaryItem}>
          <strong>Stati:</strong>
