    ...
    <div className={styles.section}>
      ...
      <div className={stylesPosition.infoGrid}>
        ...
        <div className={stylesPosition.infoItem}>
          ...
          <span className={stylesPosition.infoValue}>{device?.city || 'Non specificata'}</span>
        </div>
        <div className={stylesPosition.infoItem}>
          <span className={stylesPosition.infoLabel}>Provincia</span>
          <span className={stylesPosition.infoValue}>{device?.province || 'Non specificata'}</span>
        </div>
        <div className={stylesPosition.infoItem}>
        ...
        <div className={stylesPosition.infoItem}>
          ...
          <span className={stylesPosition.infoValue}>{device?.country || 'Non specificato'}</span>
        </div>
        <div className={stylesPosition.infoItem}>
