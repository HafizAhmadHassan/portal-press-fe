...
export const selectCollapseItems = (state: RootState) => state.ui.collapse.items;
export const selectActiveGroup = (state: RootState) => state.ui.collapse.activeGroup;
export const selectCollapseLoading = (state: RootState) => state.ui.collapse.isLoading;
export const selectCollapseError = (state: RootState) => state.ui.collapse.error;
...
export const selectCollapseStats = createSelector(
  ...
  (items) => {
    ...
    return {
      ...
      openPercentage: itemsArray.length > 0 ? (open.length / itemsArray.length) * 100 : 0,
